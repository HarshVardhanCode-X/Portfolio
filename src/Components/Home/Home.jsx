    ...
    <>
      ...
      <section className="w-full">
        <div className="bg-[#2D2D2D] w-full ">
          <header className="bg-[#2D2D2D] px-2 sticky inset-0 h-[9vh] flex items-center justify-center z-40">
            ...
            <div className="w-full bg-[#0D0D0D] h-full rounded-[20px]">
              <div className="flex flex-col items-center justify-center relative h-full ">
                ...
                <div
                  ...
                  <img src="./Images/yourimage.png" className="" alt="Your Image" />
                </div>
                <div className="z-40 fixed bottom-[6vh] flex justify-center items-center rounded-full">
                  <div className="flex space-x-4 bg-gradient-to-r text-[gray] from-[rgba(255,255,255,0.75)] via-[rgba(255,255,255,0.25)] to-[rgba(255,255,255,0.05)] backdrop-blur-3xl rounded-full px-[3vh] py-[2vh] border border-[rgba(255,255,255)]">
                    <a href="#" className=" text-[14px] flex items-center hover:text-gray-800 px-5 hover:bg-[#D0F034] rounded-full py-2">Work</a>
                    <a href="#" className=" text-[14px] flex items-center hover:text-gray-800 px-5 hover:bg-[#D0F034] rounded-full py-2">About Me</a>
                    <a href="#" className=" text-[14px] flex items-center hover:text-gray-800 px-5 hover:bg-[#D0F034] rounded-full py-2">Contact</a>
                  </div>
                </div>
              </div>
            </div>
